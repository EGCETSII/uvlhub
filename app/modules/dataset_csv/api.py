...
def init_blueprint_api(api):
    api.add_resource(DataSetResource, "/api/v1/csvdatasets/", endpoint="csvdatasets")
    api.add_resource(DataSetResource, "/api/v1/csvdatasets/<int:id>", endpoint="csvdataset")
